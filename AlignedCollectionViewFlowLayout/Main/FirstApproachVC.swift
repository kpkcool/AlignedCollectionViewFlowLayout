...
class FirstApproachVC: UIViewController {
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = "Review Images • Approach 1"
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        alignedFlowLayout.minimumLineSpacing = FirstApproachVC.verticalSpaceBetweenImages
        alignedFlowLayout.minimumInteritemSpacing = FirstApproachVC.horizontalSpaceBetweenImages
    ...
    func setupUI(){
        ...
        NSLayoutConstraint.activate([
            ...
            collectionView.heightAnchor.constraint(equalToConstant: calculateCollectionViewHeightAndWidth(widthPerItem: FirstApproachVC.widthPerItem()).height),
            collectionView.widthAnchor.constraint(equalToConstant: calculateCollectionViewHeightAndWidth(widthPerItem: FirstApproachVC.widthPerItem()).width)
        ])
    }
...
extension FirstApproachVC: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: FirstApproachVC.widthPerItem(), height: FirstApproachVC.widthPerItem())
    }
